...
#pragma comment(lib, "MyMathDef.lib")
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	TCHAR szAppName[] = TEXT("DLLClientImplicitDefPragmaWay");
	...
	hwnd = CreateWindow(szAppName, TEXT("DLL Implicit with DEF Pragma way"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);
