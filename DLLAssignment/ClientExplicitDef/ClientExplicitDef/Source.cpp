...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	TCHAR szAppName[] = TEXT("DLLClientExplicitDef");
	...
	hwnd = CreateWindow(szAppName, TEXT("DLL Explicit DEF"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam) {
	...
	HMODULE hDll;
	hDll = LoadLibrary(TEXT("MyMathDef.dll"));
	int i = 9;
	TCHAR resultStr[255];
