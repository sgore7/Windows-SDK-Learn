...
class CSumSubtract : public ISum, public ISubtract, public IMultiplication, public IDivision {
private:
	long m_cRef;
...
HRESULT CSumSubtract::SumOfTwoIntegers(int m, int n, int* res) {
	*res = m + n;
	return(S_OK);
}

HRESULT CSumSubtract::SubtractionOfTwoIntegers(int m, int n, int* res) {
	*res = m - n;
	return(S_OK);
}

HRESULT CSumSubtract::MultiplicationOfTwoIntegers(int m, int n, int* res) {
	m_pIMultiplication->MultiplicationOfTwoIntegers(m, n, res);
	return(S_OK);
}

HRESULT CSumSubtract::DivisionOfTwoIntegers(int m, int n, int* res) {
	m_pIDivision->DivisionOfTwoIntegers(m, n, res);
	return(S_OK);
}
